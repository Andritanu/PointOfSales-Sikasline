            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="form-group text-right">
                        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModal">Add new Brands</button>
                    </div>
                </div>
            </div>
          ...
          <div class="modal-footer">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td>{{ $merek->merek }}</td>
                    <td>
                        <form action="{{ route('merek.destroy',$merek->kd_merek) }}" method="POST">
            
                            <a class="btn btn-outline-primary" href="{{ route('merek.edit',$merek->kd_merek) }}">Edit</a>
