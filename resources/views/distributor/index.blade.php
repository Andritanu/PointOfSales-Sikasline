            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12 margin-tb">
                    <div class="form-group text-right">
                        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModal">Add new Distributor</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
          ...
          <form action="{{ route('distributor.store') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input name="nama_distributor" type="text" class="form-control" id="distributor" aria-describedby="distributor" placeholder="Distributor" >
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('distributor.destroy',$distributor->kd_distributor) }}" method="POST" >
                                    ...
                                    <a class="btn btn-outline-primary" href="{{ route('distributor.edit',$distributor->kd_distributor) }}">Edit</a>
                
                                    @csrf
                                    @method('DELETE')
                    
                                    <button type="submit" class="btn btn-outline-danger" onclick="return confirm('Are you delete ?');">Hapus</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
